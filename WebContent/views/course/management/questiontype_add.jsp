  ...
  <div class="layui-form" lay-filter="course" id="course" style="padding: 20px 30px 0 0;">
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline">
        <input type="text" name="questiontypeName" lay-verify="required" placeholder="请输入题型名称" autocomplete="off" class="layui-input">
      </div>
    </div>
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline">
        <input type="checkbox" id="open" name="open" class="layui-input-inline" lay-skin="switch" lay-filter="switchTest-project" lay-text="开启|关闭" >
      </div>
    </div>
...
<!--    <div class="layui-form-item" style="display:none;" id="options">
    ...
    <div class="layui-form-item" style="display:none;" id="answer">
      ...
      <div class="layui-input-inline">
        <input type="checkbox" id="multiple" name="multiple" class="layui-input-inline" lay-skin="switch" lay-filter="switchTest"  lay-text="开启|关闭" >      
      </div>
    </div>
    <div class="layui-form-item layui-hide">
      <input type="button" lay-submit lay-filter="questiontype-add-submit" id="questiontype-add-submit" value="确认添加">
    </div>
  </div>
  ...
  layui.config({
    ...
    //监听提交
    form.on('submit(questiontype-add-submit)', function(data){
      ...
      $.ajax({
            url:'${pageContext.request.contextPath}/addquestiontype',
            type:'post',
            data:{
...
            success:function(data){
				...
				if(data){
					...
					var popup=parent.layer.alert('添加题型成功！',{closeBtn:0,icon: 1},function(){
					...
					var popup=parent.layer.alert('添加题型失败！<br/>题型或许已存在',{closeBtn:0,icon: 2},function(){
						parent.layer.close(popup);
					});
				}
