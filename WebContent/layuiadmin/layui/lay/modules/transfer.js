...
function(e) {
    ...
    x.prototype.renderData = function() {
        ...
        e.parseData(function(e) {
            ...
            n = ["<li style=\"margin-bottom:20px;\" class=\"root\">", '<input  id="checkbox'+e.value+'"   type="checkbox" name="' + a[t].checkName + '" lay-skin="primary"  lay-filter="layTransferCheckbox" title="' + e.title.substring(0, 20) +(e.title.length>20?" ....":"")+ '"' + (e.disabled ? " disabled": "") + (e.checked ? " checked": "") + ' value="' + e.value + '" ><button id="'+e.value+'" value="'+e.title+'" onclick="search_question(this)" style="position:relative;left:430px;bottom:30px"  type="button" class="layui-btn layui-btn-primary layui-btn-sm"><i class="layui-icon">&#xe615;</i></button>', "</li>"].join("");
            a[t].views.push(n),
            delete e.selected
        }),
    ...
    x.prototype.events = function() {
        ...
        function() {
            ...
            l.each(function() {
                ...
                t1 = e.find('button');
                i1 = t1[0].value.indexOf(n) !== -1;
                e[i1 ? "removeClass": "addClass"](c),
                t.data("hide", !i1);
            }),
            e.renderCheckBtn();
